...
# Circle
python .agents/skills/construct3-copilot/scripts/generate_imagedata.py --color blue --width 16 --height 16 --shape circle

# Rounded rectangle
python .agents/skills/construct3-copilot/scripts/generate_imagedata.py --color green --width 64 --height 16 --shape rounded
