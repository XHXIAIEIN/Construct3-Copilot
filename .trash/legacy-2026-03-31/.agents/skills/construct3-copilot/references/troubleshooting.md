...
| Bad JSON | Validate with `.agents/skills/construct3-copilot/scripts/validate_output.py` |
...
```bash
python .agents/skills/construct3-copilot/.agents/skills/construct3-copilot/scripts/validate_output.py '{"is-c3-clipboard-data":true,...}'
```
