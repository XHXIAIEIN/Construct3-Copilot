...
```bash
# 必须执行！
python .agents/skills/construct3-copilot/scripts/query_schema.py search {关键词}
python .agents/skills/construct3-copilot/scripts/query_schema.py plugin sprite {ace}
python .agents/skills/construct3-copilot/scripts/query_schema.py behavior platform {ace}
```
...
python .agents/skills/construct3-copilot/scripts/query_schema.py plugin sprite set-animation
python .agents/skills/construct3-copilot/scripts/query_schema.py behavior platform simulate-control
python .agents/skills/construct3-copilot/scripts/query_schema.py search <关键词>

# 2. 查询案例库（学习真实用法）
python .agents/skills/construct3-copilot/scripts/query_examples.py action set-animation
python .agents/skills/construct3-copilot/scripts/query_examples.py condition on-collision
python .agents/skills/construct3-copilot/scripts/query_examples.py top actions 20
```
...
1. 运行 `.agents/skills/construct3-copilot/scripts/validate_output.py '<json>'`
2. 检查所有引用的对象/变量是否已定义
3. 确保 ACE ID 正确 (使用 `.agents/skills/construct3-copilot/scripts/query_schema.py` 验证)
